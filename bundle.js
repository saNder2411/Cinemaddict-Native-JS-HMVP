...
class Api {
  ...
  addComment(cardId, newCommentData) {
    return this._load({
      ...
      .then((response) => response.json())
      .then((result) => {
        const card = _models_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseCard(result.movie);
        const comments = _models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(result.comments);
...
/* harmony import */ var _models_card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/card.js */ "./src/models/card.js");
...
class Provider {
  ...
  getCards() {
    ...
    return Promise.resolve(_models_card_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseCards(storeCards));
  }
  ...
  updateCard(oldCardId, modCard) {
    ...
    const fakeUpdateCard = _models_card_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseCard(Object.assign({}, modCard.getModelToRAW(), {id: oldCardId}));
  ...
  _getCommentsCardFromStore(cardId) {
    ...
    return comments.length > 0 ? _models_comment_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseComments(comments) : comments;
  }
  ...
  addComment(cardId, newCommentData) {
    ...
    const fakeNewComment = _models_comment_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseComment(Object.assign({}, {id: fakeNewCommentId, author: `User Name`}, newCommentData));
    ...
    const result = {
      card: _models_card_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseCard(storeCard),
...
class AbstractComponent {
  ...
  getElement() {
    if (!this._element) {
      this._element = _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(this.getTemplate());
    }
...
const createCardDetailsTemplate = (card, option = {}) => {
  ...
  const formateDate = `${moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`DD MMMM YYYY`)}`;
  const duration = _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].getTimeInHoursAndMinutes(runtime);
  const formatDuration = _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].getRuntimeInString(duration);
...
class CardDetails extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
    this._card = card;
  ...
  renderCommentsMarkup(comments) {
    ...
    const commentsMarkup = comments.map((it) => {
      const text = he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(it.comment);
      const commentDate = moment__WEBPACK_IMPORTED_MODULE_2___default()(it.date).fromNow();
  ...
  _escapesCommentText(comments) {
    comments.forEach((it) => {
      it.comment = he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(it.comment);
    });
  }
  ...
  _subscribeOnEvents() {
    ...
    element.querySelector(`.film-details__control-label--watchlist`)
      .addEventListener(`click`, _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].debounce(() => {
  ...
  setUserDetailsClickHandler(handler) {
    this.getElement().querySelector(`.form-details__middle-container`)
      .addEventListener(`click`, _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].debounce((evt) => {
...
const createCardTemplate = (card) => {
  ...
  const formatData = moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`YYYY`);
...
class Card extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setWatchlistButtonClickHandler(handler) {
    this.getElement().querySelector(`.film-card__controls-item--add-to-watchlist`)
      .addEventListener(`click`, _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["default"].debounce(handler));
  }
...
const createFiltersTemplate = (filterValues) => {
  ...
  return (
    `<nav class="main-navigation">
      <a href="#all" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL}" class="main-navigation__item main-navigation__item--active">All movies</a>
      <a href="#watchlist" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCHLIST}" class="main-navigation__item">Watchlist <span class="main-navigation__item-count">${watchlist}</span></a>
      <a href="#history" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALREADY_WATCHED}" class="main-navigation__item">History <span class="main-navigation__item-count">${alreadyWatched}</span></a>
      <a href="#favorites" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITE}" class="main-navigation__item">Favorites <span class="main-navigation__item-count">${favorite}</span></a>
      <a href="#stats" id="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].STATISTICS}" class="main-navigation__item main-navigation__item--additional">Stats</a>
    </nav>`
  );
};
...
/***/ "./src/components/loading-cards.js":
/*!*****************************************!*\
  !*** ./src/components/loading-cards.js ***!
  \*****************************************/
/*! exports provided: default */
...
class LoadingCards extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Sort extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setSortTypeDefault() {
    const sortDefault = this.getElement().querySelector(`a[data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}"]`);
...
const createStatsTemplate = (option = {}) => {
  ...
  const {alreadyWatched, topGenre, allRuntime} = _utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"].calcStatsDefaultData(cards);
  const allDuration = _utils_common_js__WEBPACK_IMPORTED_MODULE_2__["default"].getTimeInHoursAndMinutes(allRuntime);
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderChart() {
    ...
    this._resetChart();
    this._statsChart = _utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"].renderStatsChart(statsCtx, this._cards, this._dateFrom, this._dateTo);
  }
...
class UserRank extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(rank) {
    super();
    this._rank = rank;
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: SortType, ModeView, FilterType, ModeRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SortType", function() { return SortType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModeView", function() { return ModeView; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterType", function() { return FilterType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModeRequest", function() { return ModeRequest; });
const SortType = {
  DEFAULT: `default`,
  DATE: `date`,
  RATING: `rating`,
...
const ModeRequest = {
  isCommentAdd: `commentAdd`,
  isUserDetailsChange: `userDetailsChange`,
};
...
/* harmony import */ var _components_card_details_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/card-details.js */ "./src/components/card-details.js");
...
class CardController {
  constructor(container, onDataChange, onViewChange, onCommentDataDelete, onCommentDataAdd, onUserDetailsDataChange, api) {
    ...
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeView"].DEFAULT;
    this._cardId = null;
  ...
  render(card, mode) {
    ...
    this._cardDetailsComponent = new _components_card_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](card);
    ...
    switch (mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeView"].DEFAULT:
        if (oldCardComponent && oldCardDetailsComponent) {
          _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldCardComponent, this._cardComponent);
          _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldCardDetailsComponent, this._cardDetailsComponent);
          this._hideCardDetailsOnClick();
        } else {
          _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].renderMarkup(this._container, this._cardComponent);
        }
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeView"].DETAILS:
        if (oldCardComponent && oldCardDetailsComponent) {
          _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldCardComponent, this._cardComponent);
          _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldCardDetailsComponent, this._cardDetailsComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].renderMarkup(document.body.lastElementChild, this._cardDetailsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].renderPosition().BEFOREBEGIN);
        break;
    }
  }
  ...
  destroy() {
    _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].remove(this._cardComponent);
    _utils_render__WEBPACK_IMPORTED_MODULE_3__["default"].remove(this._cardDetailsComponent);
  ...
  _showCardDetailsOnClick(evt) {
    ...
    if (InteractiveElementsCard[evt.target.className]) {
      this._onViewChange();
      this._mode = _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeView"].DETAILS;
  ...
  setDefaultView() {
    if (this._mode !== _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeView"].DEFAULT) {
      this._hideCardDetailsOnClick();
    }
  }

  shake(modeRequest = false, userRatingId = false) {
    const isCommentAdd = modeRequest === _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeRequest"].isCommentAdd ? true : false;
    const isUserDetailsChange = modeRequest === _const_js__WEBPACK_IMPORTED_MODULE_4__["ModeRequest"].isUserDetailsChange ? true : false;
    const externalData = {
      deleteCommentId: ``,
...
class FilterController {
  ...
  render() {
    ...
    const filterValues = _utils_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"].calcFilterValues(allCards, Object.values(_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"]));
    const oldFilterComponent = this._filterComponent;

    this._filterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](filterValues);
    this._filterComponent.setFilterClickHandler(this._onFilterChange);

    if (oldFilterComponent) {
      _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldFilterComponent, this._filterComponent);
    } else {
      _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["default"].renderMarkup(container, this._filterComponent);
    }


    const dateTo = new Date();
    const dateFrom = null;
    const userRank = _utils_common_js__WEBPACK_IMPORTED_MODULE_5__["default"].calcUserRank(filterValues.alreadyWatched, ...ValuesForUserRank);
    const oldStatsComponent = this._statsComponent;

    this._userRank = userRank;
    this._statsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](allCards, dateFrom, dateTo, userRank);
    this._filterComponent.setStatsClickHandler(this._showStats);

    if (oldStatsComponent) {
      _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["default"].replace(oldStatsComponent, this._statsComponent);
      this._statsComponent.hide();
    } else {
      _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["default"].renderMarkup(container, this._statsComponent);
      this._statsComponent.hide();
    }
  }
  ...
  _showStats(filterType) {
    if (filterType === _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].STATISTICS) {
...
/* harmony import */ var _components_no_cards_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-cards.js */ "./src/components/no-cards.js");
/* harmony import */ var _components_loading_cards_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/loading-cards.js */ "./src/components/loading-cards.js");
/* harmony import */ var _components_cards_container_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/cards-container.js */ "./src/components/cards-container.js");
...
/* harmony import */ var _card_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./card.js */ "./src/controllers/card.js");
...
const renderCards = (cardsContainer, cards, onDataChange, onViewChange, onCommentDataDelete, onCommentDataAdd, onUserDetailsDataChange, api) => {
  return cards.map((card) => {
    const cardController = new _card_js__WEBPACK_IMPORTED_MODULE_6__["default"](cardsContainer, onDataChange, onViewChange, onCommentDataDelete, onCommentDataAdd, onUserDetailsDataChange, api);

    cardController.render(card, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeView"].DEFAULT);
...
const renderExtraCards = (container, cards, onDataChange, onViewChange, onCommentDataDelete, onCommentDataAdd, onUserDetailsDataChange, sortProp, api) => {
  return cards
    ...
    .map((card) => {
      const cardController = new _card_js__WEBPACK_IMPORTED_MODULE_6__["default"](container, onDataChange, onViewChange, onCommentDataDelete, onCommentDataAdd, onUserDetailsDataChange, api);
...
class PageController {
  constructor(container, cardsModel, api) {
    ...
    this._loadingCardsComponent = new _components_loading_cards_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._cardsContainerComponent = new _components_cards_container_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    this._showMoreButtonComponent = new _components_show_more_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  renderLoadingMassage() {
    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderMarkup(this._container, this._sortComponent);
    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderMarkup(this._container, this._loadingCardsComponent);
  }
  ...
  render() {
    ...
    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].remove(this._loadingCardsComponent);

    if (!isCards) {
      _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderMarkup(this._container, this._noCardsComponent);
      return;
    }

    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderMarkup(this._container, this._cardsContainerComponent);
  ...
  _renderShowMoreButton() {
    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].remove(this._showMoreButtonComponent);

    if (this._showingCardsAmount >= this._cardsModel.getCards().length) {
      return;
    }

    _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderMarkup(this._mainCardsContainer, this._showMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["default"].renderPosition().AFTEREND);
  ...
  _isSuccessDataChange(cardController, card, newCard) {
    ...
    if (isSuccess) {
      ...
      cardController.render(newCard, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeView"].DEFAULT);
    }
  }
  ...
  _isSuccessCommentDataAdd(cardController, oldCard, newCard, newComments) {
    ...
    if (isSuccessCardDataChange) {
      this._updateCards(this._showingCardsAmount);
      cardController.render(newCard, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeView"].DETAILS);
  ...
  _onCommentDataAdd(cardController, oldCard, newCommentData) {
    this._api.addComment(oldCard.id, newCommentData)
      ...
      .catch(() => {
        this._isErrorDataChange(cardController, oldCard, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeRequest"].isCommentAdd);
      });
  }
  ...
  _isSuccessCommentDataDelete(cardController, card, commentId) {
    ...
    if (isSuccessCommentDataDelete) {
      ...
      cardController.render(card, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeView"].DETAILS);
  ...
  _isSuccessUserRatingDataChange(cardController, card, newDataCard) {
    ...
    if (isSuccess) {
      ...
      cardController.render(newDataCard, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeView"].DETAILS);
      cardController.renderUpdatedComments(newListComments);
    }
  }
  ...
  _onUserDetailsDataChange(cardController, oldDataCard, newDataCard, userRatingId) {
    this._api.updateCard(oldDataCard.id, newDataCard)
      ...
      .catch(() => {
        this._isErrorDataChange(cardController, oldDataCard, _const_js__WEBPACK_IMPORTED_MODULE_7__["ModeRequest"].isUserDetailsChange, userRatingId);
      });
  }
...
/* harmony import */ var _components_user_rank_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/user-rank.js */ "./src/components/user-rank.js");
...
/* harmony import */ var _models_cards_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/cards.js */ "./src/models/cards.js");
...
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_1__["default"](STORE_NAME, COMMENTS_STORE_NAME, window.localStorage);

const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_2__["default"](api, store);
const cardsModel = new _models_cards_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const siteHeader = document.querySelector(`.header`);
const siteMain = document.querySelector(`.main`);
const footerStatistic = document.querySelector(`.footer__statistics p`);

const pageController = new _controllers_page_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteMain, cardsModel, apiWithProvider);
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteMain, cardsModel, pageController);
...
apiWithProvider.getCards()
  .then((cards) => {
    ...
    _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["default"].renderMarkup(siteHeader, new _components_user_rank_js__WEBPACK_IMPORTED_MODULE_3__["default"](userRank));
...
class Cards {
  ...
  getCards() {
    return _utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"].getCardsByFilter(this._cards, this._activeFilterType);
  }
...
class Filter {
  ...
  static getCardsByFilter(cards, filterType) {
    switch (filterType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALREADY_WATCHED:
        return this.getAlreadyWatchedCards(cards);
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITE:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StatisticsUtils; });
...
class StatisticsUtils {
  ...
  static renderStatsChart(statsCtx, cards, dateFrom, dateTo) {
    ...
    return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(statsCtx, {
